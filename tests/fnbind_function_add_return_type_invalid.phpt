...
$retval = fnbind_function_add('fnbind_function', 'string $a, $valid=false', 'return $valid ? $a : new stdClass();', false, '/** doc comment */', 'string#');
...
?>
--EXPECTF--
Warning: fnbind_function_add(): Return type should match regex %s in %s on line %d
